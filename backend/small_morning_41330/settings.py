"""
Django settings for small_morning_41330 project.
...
ROOT_URLCONF = 'small_morning_41330.urls'
...
WSGI_APPLICATION = 'small_morning_41330.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "small_morning_41330 API",
    "DESCRIPTION": "API documentation for small_morning_41330 App",
    "VERSION": "v1",
}
